...
public class ScheduleResource {
    ...
    @Timed
    public ResponseEntity<List<ScheduleDTO>> getAllSchedules(@ApiParam Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<ScheduleDTO>> searchSchedules(@RequestParam String query, @ApiParam Pageable pageable) {
