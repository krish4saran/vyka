...
class PaymentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Payment entity")
        ...
        .repeat(2) {
            ...
            .post("/api/payments")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "totalAmount":"0", "localCurrencyCode":"SAMPLE_TEXT", "settlementCurrencyCode":"SAMPLE_TEXT", "capturedAmount":"0", "canceledAmount":"0", "refundAmount":"0", "paymentVia":null, "createdDate":"2020-01-01T00:00:00.000Z", "updatedDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
